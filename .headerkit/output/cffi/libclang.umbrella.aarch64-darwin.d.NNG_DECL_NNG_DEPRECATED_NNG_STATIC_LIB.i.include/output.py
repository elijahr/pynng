...
#define NNG_BUS0_SELF 112
#define NNG_BUS0_PEER 112
...
#define NNG_SURVEYOR0_SELF 98
#define NNG_SURVEYOR0_PEER 99
#define NNG_RESPONDENT0_SELF 99
#define NNG_RESPONDENT0_PEER 98
struct nng_ctx_s {
    uint32_t id;
};
...
int nng_socket_set_addr(nng_socket, const char *, union nng_sockaddr *);
...
int nng_socket_get_addr(nng_socket, const char *, union nng_sockaddr *);
...
const char * nng_str_sockaddr(union nng_sockaddr * sa, char * buf, size_t bufsz);
typedef enum {
...
int nng_dialer_set_addr(nng_dialer, const char *, union nng_sockaddr *);
...
int nng_dialer_get_addr(nng_dialer, const char *, union nng_sockaddr *);
...
int nng_listener_set_addr(nng_listener, const char *, union nng_sockaddr *);
...
int nng_listener_get_addr(nng_listener, const char *, union nng_sockaddr *);
...
int nng_aio_set_iov(nng_aio *, unsigned int, struct nng_iov *);
...
int nng_pipe_get_addr(nng_pipe, const char *, union nng_sockaddr *);
...
int nng_url_parse(struct nng_url **, const char *);
void nng_url_free(struct nng_url *);
int nng_url_clone(struct nng_url **, struct nng_url *);
...
int nng_stream_get_addr(nng_stream *, const char *, union nng_sockaddr *);
...
int nng_stream_dialer_alloc_url(nng_stream_dialer **, struct nng_url *);
...
int nng_stream_dialer_get_addr(nng_stream_dialer *, const char *, union nng_sockaddr *);
...
int nng_stream_dialer_set_addr(nng_stream_dialer *, const char *, union nng_sockaddr *);
int nng_stream_listener_alloc(nng_stream_listener **, const char *);
int nng_stream_listener_alloc_url(nng_stream_listener **, struct nng_url *);
...
int nng_stream_listener_get_addr(nng_stream_listener *, const char *, union nng_sockaddr *);
...
int nng_stream_listener_set_addr(nng_stream_listener *, const char *, union nng_sockaddr *);
typedef struct nng_udp nng_udp;
int nng_udp_open(nng_udp ** udpp, union nng_sockaddr * sa);
void nng_udp_close(nng_udp * udp);
int nng_udp_sockname(nng_udp * udp, union nng_sockaddr * sa);
void nng_udp_send(nng_udp * udp, nng_aio * aio);
void nng_udp_recv(nng_udp * udp, nng_aio * aio);
int nng_udp_multicast_membership(nng_udp * udp, union nng_sockaddr * sa, _Bool join);
...
int nng_dialer_getopt_sockaddr(nng_dialer, const char *, union nng_sockaddr *);
...
int nng_listener_getopt_sockaddr(nng_listener, const char *, union nng_sockaddr *);
...
int nng_pipe_getopt_sockaddr(nng_pipe, const char *, union nng_sockaddr *);
...
void nng_closeall(void);
int nng_stream_set_addr(nng_stream *, const char *, union nng_sockaddr *);
int nng_ctx_get_addr(nng_ctx, const char *, union nng_sockaddr *);
int nng_ctx_set_addr(nng_ctx, const char *, union nng_sockaddr *);
...
int nng_dialer_get_url(nng_dialer, struct nng_url **);
int nng_listener_get_url(nng_listener, struct nng_url **);
...
int nng_tls_config_psk(nng_tls_config *, const char *, uint8_t *, size_t);
...
_Bool nng_tls_engine_fips_mode(void);
int nng_tls_register(void);
#define NNG_MAJOR_VERSION ...
#define NNG_MINOR_VERSION ...
#define NNG_PATCH_VERSION ...
